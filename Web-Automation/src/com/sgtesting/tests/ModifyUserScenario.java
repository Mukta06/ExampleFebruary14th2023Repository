...
//			System.out.println(text);
			...
			Browser.findElement(By.name("password")).sendKeys("Muktacb123");
			Thread.sleep(1000);
			Browser.findElement(By.name("passwordCopy")).sendKeys("Muktacb123");
			Thread.sleep(1000);
			Browser.findElement(By.xpath("//span[text()='Save Changes']")).click();
			Thread.sleep(1000);
